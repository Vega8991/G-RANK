...
interface RanksSectionProps {
    ...
    selectedRank: RankItem;
    selectedRankProgress: number;
}

function RanksInlineSection({ selectedRankName, onSelectRank, selectedRank, selectedRankProgress }: RanksSectionProps) {
    return (
...
function FeaturesInlineSection() {
    return (
        <section className="py-20 md:py-28 px-4 md:px-20">
            <div className="max-w-[1512px] mx-auto">
                <motion.div
        ...
        <div className="bg-[var(--neutral-bg)] text-white relative">
            ...
            <div className="relative z-10 pointer-events-auto">
                ...
                <RanksInlineSection
                    ...
                    onSelectRank={setSelectedRankName}
                    selectedRank={selectedRank}
                    selectedRankProgress={selectedRankProgress}
                />

                <FeaturesInlineSection />

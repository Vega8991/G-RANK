...
import { Crown, Eye, EyeOff, AlertCircle, CheckCircle, RefreshCw, Trophy, Target, TrendingUp } from "lucide-react";
                ...
                >
                    ...
                    <div className="bg-[var(--neutral-surface)]/40 backdrop-blur-lg border border-[var(--neutral-border)]/40 rounded-2xl p-8 md:p-10">
                        ...
                        <p className="text-center text-sm text-[var(--neutral-text-muted)] mt-8">
                            ...
                            <NavLink to="/register" className="font-semibold text-[var(--brand-primary)] hover:text-[var(--brand-primary-hover)] transition-colors duration-300">
                                Create one
                            </NavLink>
                        </p>
                    </div>

...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(function ButtonComponent({ variant = "primary", className = "", children, ...props }, ref) {
    const variantClass = buttonVariants[variant] || buttonVariants.primary;
    const baseClass = "rounded-md font-semibold transition-all duration-300 flex items-center gap-2 justify-center";
